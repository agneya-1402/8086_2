...
;       Check if ball has passed  left boundarie (BALL_X < 0 + WINDOW_BOUNDS)
;       If colliding, restart position		
		MOV AX,WINDOW_BOUNDS
		CMP BALL_X,AX                    ;BALL_X is compared with the left boundarie of the screen (0 + WINDOW_BOUNDS)          
		JL GIVE_POINT_TO_PLAYER_TWO      ;if less, give one point to the player two and reset ball position
...
;       If colliding, restart position		
		...
		CMP BALL_X,AX	               ;BALL_X compared with the right boundarie of the screen (BALL_X > WINDOW_WIDTH - BALL_SIZE  - WINDOW_BOUNDS)  
		JG GIVE_POINT_TO_PLAYER_ONE     ;if greater, give one point to the player one and reset ball position
...
;       Checking whick key was pressed
			CMP AL,'S'
